...
WANDB_ENTITY=ankile DIFF_BASE=/data/scratch/ankile WANDB_MODE=online python script/train_diffusion.py --config-name=finetune_ppo_diffusion_unet_furniture --config-dir=cfg/robomimic/ppo-ft-state
