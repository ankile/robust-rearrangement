...
def create_panda_urdf():
    ...
    urdf = URDFWithCanonPCDS(yourdfpy.URDF.load("assets/franka/panda_with_gripper.urdf", build_collision_scene_graph=True, load_collision_meshes=True))
...
def compute_world_poses(urdf: URDFWithCanonPCDS, joint_values: np.ndarray, type: str="numpy"):
    jnt = joint_values
    # jnt = joint_values[:-1]
