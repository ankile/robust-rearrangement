...
while true; do
    ...
    # python -m src.eval.evaluate_model --n-envs 20 --n-rollouts 100 --randomness low --run-id teleop-finetune/runs/fzwwjbe0 -f square_table --n-parts-assemble 2 --save-rollouts
done
